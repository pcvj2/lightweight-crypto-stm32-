...
Overview
This project demonstrates a simulated, secure drone system between a STM32767ZI and a PC. The STM32 firmware simulates drone data, encrypts it using Blowfish and sends it over UART. A Python script decrypts the data and displays it in real-time using live plots.
...
•	Run python Ground_Station_decryptor.py in command terminal (or similar)
